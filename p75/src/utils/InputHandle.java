...
public class InputHandle {
    ...
    public String validateFilePath(String msg) {
        while (true) {
            ...
            String regexFile = "^[A-Z]:\\\\(?:[a-zA-Z]+\\\\)*[a-zA-Z]+\\.(txt|gif|pdf|doc|docx|xls|xlsx|js)$";
            String regexDirectory = "^[A-Z]:\\\\(?:[a-zA-Z]+\\\\?)*$";
    ...
    public long getNumeric(String msg) {
        while (true) {
            System.out.print(msg);
            String value = scanner.nextLine().trim();
            ...
            try {
                long sizeInByte = Long.parseLong(value) * 1024;

                if (sizeInByte < 0) {
                    System.err.println("size must > 0!");
                } else {
                    return sizeInByte;
                }

            } catch (NumberFormatException e) {
                System.err.println("Value of size is digit!");
            }
        }
    }
